...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ \"./src/index.js\");\n\n\nconst tasksDiv = document.querySelector('.tasksDiv');\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {\n  tasksDiv.addEventListener('click', (e) => {\n    if (e.target.classList.contains('fa-square')) {\n      for (let i = 0; i < _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks.length; i += 1) {\n        if (_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].id === +e.target.parentElement.getAttribute('data-id')) {\n          _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].completed === false ? _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].completed = true\n            : _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].completed = false;\n          (0,_index_js__WEBPACK_IMPORTED_MODULE_0__.saveToStorage)(_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks);\n        }\n        if (_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].completed && _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].id === +e.target.parentElement.getAttribute('data-id')) {\n          e.target.parentElement.childNodes[0].style.background = 'black'\n        }\n        if (!_index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].completed && _index_js__WEBPACK_IMPORTED_MODULE_0__.arrayOfTasks[i].id === +e.target.parentElement.getAttribute('data-id')) {\n            e.target.parentElement.childNodes[0].style.background = 'white'\n        }\n      }\n    }\n  });\n});\n\n\n\n//# sourceURL=webpack://to-do/./src/modules/complete.js?");
>>>>>>> 429d0b022f0c6a877fd4954afac5775f6c28dd44
